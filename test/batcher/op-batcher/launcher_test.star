...
def test_batcher_launcher_launch_without_conductor(plan):
    ...
    expect.eq(
        ...
        [
            "op-batcher",
            "--l2-eth-rpc=http://op-el-1-op-reth-op-node-network0:8545,http://op-el-2-op-reth-op-node-network0:8545",
            "--rollup-rpc=http://op-cl-1-op-node-op-reth-network0:8547,http://op-cl-2-op-node-op-reth-network0:8547",
            "--poll-interval=1s",
            "--sub-safety-margin=6",
            "--num-confirmations=1",
...
def test_batcher_launcher_launch_with_conductor(plan):
    ...
    expect.eq(
        ...
        [
            "op-batcher",
            "--l2-eth-rpc=http://op-el-1-op-reth-op-node-network0:8545,http://op-conductor-2151908-network0-node1:8547",
            "--rollup-rpc=http://op-cl-1-op-node-op-reth-network0:8547,http://op-conductor-2151908-network0-node1:8547",
            "--poll-interval=1s",
            "--sub-safety-margin=6",
            "--num-confirmations=1",
            "--safe-abort-nonce-too-low-count=3",
